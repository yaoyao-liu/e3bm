...
mv val1000Episode_5_way_5_shot.json miniImageNet/
...
mv val1000Episode_5_way_1_shot.json miniImageNet/

wget https://www.dropbox.com/s/t36y8ng47wlcxw0/netFeatBest64.653.pth?dl=0
mv netFeatBest64.653.pth?dl=0 netFeatBest.pth
mkdir ../ckpts
